...
namespace GameHalloran {
    ...
    public:
        ...
        explicit Pool3dGameEventListener(Pool3dGame *poolAppPtr) throw(GameException &) : m_poolAppPtr(poolAppPtr) {
            if(m_poolAppPtr == NULL) {
                throw GameException(std::string("m_poolAppPtr is NULL"));
            }
        };
        ...
        virtual char const *VGetName(void) {
            return ("Pool3dGameEventListener");
        };
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        bool IsAnisotropicTexturingAvailable() const {
            return (m_isAnisotropicExtPresent);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        virtual bool VGetLoadFilenames(const boost::filesystem::path &directoryRef, std::vector<boost::filesystem::path> &fileListRef) {
            return (true);
        };
