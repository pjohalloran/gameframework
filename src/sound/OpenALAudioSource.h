...
namespace GameHalloran
{
	...
	public:
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool IsValid() const { return (alIsSource(m_id) == AL_TRUE ? true : false); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline ALuint GetId() const { return (m_id); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool SetPosition(const Point3 &positionRef) const { return (SetFloatArrayParam(AL_POSITION, 3, positionRef.GetComponentsConst())); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool SetVelocity(const Vector3 &velRef) const { return (SetFloatArrayParam(AL_VELOCITY, 3, velRef.GetComponentsConst())); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool SetDirection(const Vector3 &directionRef) const { return (SetFloatArrayParam(AL_DIRECTION, 3, directionRef.GetComponentsConst())); };

		// ////////////////////////////////////////////////////////////////////
		// Is the sound source a directional one?
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool IsDirectional() const { Vector3 dir; GetDirection(dir); if(dir != Vector3(0, 0, 0)) { return (true); } return (false); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline U32 GetBufferQueueSize() const { ALint size(0); GetIntParam(AL_BUFFERS_QUEUED, size); return (U32(size)); };

		// ////////////////////////////////////////////////////////////////////
		// Get the number of buffers processed.
		//
		// ////////////////////////////////////////////////////////////////////
		inline U32 GetNumberBuffersProcessed() const { ALint size(0); GetIntParam(AL_BUFFERS_PROCESSED, size); return (U32(size)); };

		// ////////////////////////////////////////////////////////////////////
		// Get the pitch.
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool GetPitch(F32 &pitch) const { return (GetFloatParam(AL_PITCH, pitch)); };

		// ////////////////////////////////////////////////////////////////////
		// Set the pitch.
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool SetPitch(const F32 pitch) const { return (SetFloatParam(AL_PITCH, pitch)); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool IsStreaming() const { ALint st; return (GetIntParam(AL_SOURCE_TYPE, st) && (st == AL_STREAMING)); };

		// ////////////////////////////////////////////////////////////////////
		// Is the source playing only one buffer?
		//
		// ////////////////////////////////////////////////////////////////////
		bool IsStatic() const { ALint st; return (GetIntParam(AL_SOURCE_TYPE, st) && (st == AL_STATIC)); };

		// ////////////////////////////////////////////////////////////////////
		// Set the current playback position in seconds.
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool SetPlaybackPositionTime(const F32 seconds) const { return (SetFloatParam(AL_SEC_OFFSET, seconds)); };

		// ////////////////////////////////////////////////////////////////////
		// Set the current playback position in samples.
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool SetPlaybackPositionSamples(const F32 samples) const { return (SetFloatParam(AL_SAMPLE_OFFSET, samples)); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool SetPlaybackPositionByteOffset(const F32 byteOffset) const { return (SetFloatParam(AL_BYTE_OFFSET, byteOffset)); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool IsRelativePosition() const { ALint r; return (GetIntParam(AL_SOURCE_RELATIVE, r) && (r == AL_TRUE)); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool UseRelativePosition(const bool relative) const { return (SetIntParam(AL_SOURCE_RELATIVE, relative ? AL_TRUE : AL_FALSE)); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool IsPlaying() const { ALint state; return (GetIntParam(AL_SOURCE_STATE, state) && state == AL_PLAYING); };

		// ////////////////////////////////////////////////////////////////////
		// Check if the source state is currently stopped.
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool IsStopped() const { ALint state; return (GetIntParam(AL_SOURCE_STATE, state) && state == AL_STOPPED); };

		// ////////////////////////////////////////////////////////////////////
		// Check if the source state is currently paused.
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool IsPaused() const { ALint state; return (GetIntParam(AL_SOURCE_STATE, state) && state == AL_PAUSED); };
		...
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool SetVolume(const F32 volume) const { return (SetFloatParam(AL_GAIN, volume)); };

		// ////////////////////////////////////////////////////////////////////
		// Get the volume/gain of the sound the source is attached to.
		//
		// ////////////////////////////////////////////////////////////////////
		inline bool GetVolume(F32 &volume) const { return (GetFloatParam(AL_GAIN, volume)); };
