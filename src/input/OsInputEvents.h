...
#define GF_NUMBER_KEYS                  GLFW_KEY_LAST
    ...
    public:
        ...
        bool IsPlayerAttached() const {
            return (m_playerId != NO_PLAYER_ATTACHED);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        bool operator<(const JoystickInfo &rhs) {
