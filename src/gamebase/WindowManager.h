...
namespace GameHalloran {
    ...
    struct WindowParameters {
        ...
        //
        // /////////////////////////////////////////////////////////////////
        void SetDimensions(const I32 w, const I32 h) {
            m_w = w;
            m_h = h;
        };
        I32 GetWidth() const {
        ...
        void SetPosition(const I32 x, const I32 y) {
            m_x = x;
            m_y = y;
        };
        I32 GetXPos() const {
        ...
        void SetTitle(const std::string &titleRef) {
            m_title = titleRef;
        };
        ...
        void SetFullscreen(const bool n) {
            m_fullscreen = n;
        };
        ...
        void SetAutoPollEvents(const bool n) {
            m_autoPollEvents = n;
        };
        bool IsAutoPollEvents() const {
            return (m_autoPollEvents);
        };

        void SetKeyRepeat(const bool n) {
            m_keyRepeat = n;
        };
        ...
        void SetMouseVisible(const bool n) {
            m_mouseVisible = n;
        };
        ...
        void SetSystemKeysEnabled(const bool n) {
            m_systemKeysEnabled = n;
        };
        bool IsSystemKeysEnabled() const {
            return (m_systemKeysEnabled);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        void SetColorBuffer(const I32 r, const I32 g, const I32 b) {
            m_cbR = r;
            m_cbG = g;
            m_cbB = b;
        };
        I32 GetCBufRedBits() const {
            return (m_cbR);
        };
        I32 GetCBufGreenBits() const {
            return (m_cbG);
        };
        I32 GetCBufBlueBits() const {
            return (m_cbB);
        };

        void SetAlphaBufferSize(const I32 a) {
            m_abSize = a;
        };
        I32 GetAlphaBufferSize() const {
            return (m_abSize);
        };

        void SetDepthBufferSize(const I32 d) {
            m_dbSize = d;
        };
        I32 GetDepthBufferSize() const {
            return (m_dbSize);
        };

        void SetStencilBufferSize(const I32 s) {
            m_sbSize = s;
        };
        I32 GetStencilBufferSize() const {
            return (m_sbSize);
        };

        void SetAccumBuffer(const I32 r, const I32 g, const I32 b, const I32 a) {
            m_accumbR = r;
            m_accumbG = g;
            m_accumbB = b;
            m_accumbA = a;
        };
        I32 GetAccumBufRedBits() const {
            return (m_accumbR);
        };
        I32 GetAccumBufGreenBits() const {
            return (m_accumbG);
        };
        I32 GetAccumBufBlueBits() const {
            return (m_accumbB);
        };
        I32 GetAccumBufAlphaBits() const {
            return (m_accumbA);
        };

        void SetAuxBuffersNumber(const I32 n) {
            m_numAuxBuffers = n;
        };
        I32 GetAuxBuffersNumber() const {
            return (m_numAuxBuffers);
        };

        void SetFsaaSamplesNumber(const I32 n) {
            m_numFsaaSample = n;
        };
        I32 GetFsaaSamplesNumber() const {
            return (m_numFsaaSample);
        };

        void SetStereoRendering(const bool n) {
            m_stereoRendering = n;
        };
        bool IsStereoRendering() const {
            return (m_stereoRendering);
        };

        void SetGlVersion(const I32 majV, const I32 minV) {
            m_glMajorV = majV;
            m_glMinorV = minV;
        };
        I32 GetGlMajorVersion() const {
            return (m_glMajorV);
        };
        I32 GetGlMinorVersion() const {
            return (m_glMinorV);
        };

        // Note - If you change the GL profile then the minimum GL version must be 3.2!
        void SetGlProfile(const I32 n) {
            m_glProfile = n;
            if(m_glMajorV < 3) {
                m_glMajorV = 3;
                m_glMinorV = 2;
        ...
        I32 GetGlProfile() const {
            return (m_glProfile);
        };
        void SetGlDebugContext(const bool n) {
            m_glDebugContext = n;
        };
        bool IsGlDebugContext() const {
            return (m_glDebugContext);
        };
    };
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline GLFWwindow GetGlfwWindowPtr() const {
            return (m_glfwPtr);
        };
#endif
    };
