...
public:
	...
	void testCompleteConstructor(void)
	{
		...
		mat.GetElement(0, 0, g00);	mat.GetElement(1, 0, g10);	mat.GetElement(2, 0, g20);	mat.GetElement(3, 0, g30);
		mat.GetElement(0, 1, g01);	mat.GetElement(1, 1, g11);	mat.GetElement(2, 1, g21);	mat.GetElement(3, 1, g31);
		mat.GetElement(0, 2, g02);	mat.GetElement(1, 2, g12);	mat.GetElement(2, 2, g22);	mat.GetElement(3, 2, g32);
		mat.GetElement(0, 3, g03);	mat.GetElement(1, 3, g13);	mat.GetElement(2, 3, g23);	mat.GetElement(3, 3, g33);
	...
	void testCopyConstructor(void)
	{
		...
		mat.GetElement(0, 0, m00);	mat.GetElement(1, 0, m10);	mat.GetElement(2, 0, m20);	mat.GetElement(3, 0, m30);
		mat.GetElement(0, 1, m01);	mat.GetElement(1, 1, m11);	mat.GetElement(2, 1, m21);	mat.GetElement(3, 1, m31);
		mat.GetElement(0, 2, m02);	mat.GetElement(1, 2, m12);	mat.GetElement(2, 2, m22);	mat.GetElement(3, 2, m32);
		mat.GetElement(0, 3, m03);	mat.GetElement(1, 3, m13);	mat.GetElement(2, 3, m23);	mat.GetElement(3, 3, m33);

		VecFloat c00, c10, c20, c30;
		VecFloat c01, c11, c21, c31;
		VecFloat c02, c12, c22, c32;
		VecFloat c03, c13, c23, c33;
		copy.GetElement(0, 0, c00);	copy.GetElement(1, 0, c10);	copy.GetElement(2, 0, c20);	copy.GetElement(3, 0, c30);
		copy.GetElement(0, 1, c01);	copy.GetElement(1, 1, c11);	copy.GetElement(2, 1, c21);	copy.GetElement(3, 1, c31);
		copy.GetElement(0, 2, c02);	copy.GetElement(1, 2, c12);	copy.GetElement(2, 2, c22);	copy.GetElement(3, 2, c32);
		copy.GetElement(0, 3, c03);	copy.GetElement(1, 3, c13);	copy.GetElement(2, 3, c23);	copy.GetElement(3, 3, c33);
	...
	void testTranspose(void)
	{
		...
		exTrans.GetElement(0, 0, t00);	exTrans.GetElement(1, 0, t10);	exTrans.GetElement(2, 0, t20);	exTrans.GetElement(3, 0, t30);
		exTrans.GetElement(0, 1, t01);	exTrans.GetElement(1, 1, t11);	exTrans.GetElement(2, 1, t21);	exTrans.GetElement(3, 1, t31);
		exTrans.GetElement(0, 2, t02);	exTrans.GetElement(1, 2, t12);	exTrans.GetElement(2, 2, t22);	exTrans.GetElement(3, 2, t32);
		exTrans.GetElement(0, 3, t03);	exTrans.GetElement(1, 3, t13);	exTrans.GetElement(2, 3, t23);	exTrans.GetElement(3, 3, t33);
	...
	void testTransposed(void)
	{
		...
		VecFloat g02, g12, g22, g32;
		VecFloat g03, g13, g23, g33;
		acTrans.GetElement(0, 0, g00);	acTrans.GetElement(1, 0, g10);	acTrans.GetElement(2, 0, g20);	acTrans.GetElement(3, 0, g30);
		acTrans.GetElement(0, 1, g01);	acTrans.GetElement(1, 1, g11);	acTrans.GetElement(2, 1, g21);	acTrans.GetElement(3, 1, g31);
		acTrans.GetElement(0, 2, g02);	acTrans.GetElement(1, 2, g12);	acTrans.GetElement(2, 2, g22);	acTrans.GetElement(3, 2, g32);
		acTrans.GetElement(0, 3, g03);	acTrans.GetElement(1, 3, g13);	acTrans.GetElement(2, 3, g23);	acTrans.GetElement(3, 3, g33);
		VecFloat t00, t10, t20, t30;
		VecFloat t01, t11, t21, t31;
		VecFloat t02, t12, t22, t32;
		VecFloat t03, t13, t23, t33;
	...
	void testMultiplyMatrix(void)
	{
		...
		acRes.GetElement(0, 0, a00);	acRes.GetElement(1, 0, a10);	acRes.GetElement(2, 0, a20);	acRes.GetElement(3, 0, a30);
		acRes.GetElement(0, 1, a01);	acRes.GetElement(1, 1, a11);	acRes.GetElement(2, 1, a21);	acRes.GetElement(3, 1, a31);
		acRes.GetElement(0, 2, a02);	acRes.GetElement(1, 2, a12);	acRes.GetElement(2, 2, a22);	acRes.GetElement(3, 2, a32);
		acRes.GetElement(0, 3, a03);	acRes.GetElement(1, 3, a13);	acRes.GetElement(2, 3, a23);	acRes.GetElement(3, 3, a33);

		VecFloat e00, e10, e20, e30;
		VecFloat e01, e11, e21, e31;
		VecFloat e02, e12, e22, e32;
		VecFloat e03, e13, e23, e33;
		exRes.GetElement(0, 0, e00);	exRes.GetElement(1, 0, e10);	exRes.GetElement(2, 0, e20);	exRes.GetElement(3, 0, e30);
		exRes.GetElement(0, 1, e01);	exRes.GetElement(1, 1, e11);	exRes.GetElement(2, 1, e21);	exRes.GetElement(3, 1, e31);
		exRes.GetElement(0, 2, e02);	exRes.GetElement(1, 2, e12);	exRes.GetElement(2, 2, e22);	exRes.GetElement(3, 2, e32);
		exRes.GetElement(0, 3, e03);	exRes.GetElement(1, 3, e13);	exRes.GetElement(2, 3, e23);	exRes.GetElement(3, 3, e33);
		...
		// Test the iTest == a
		a.GetElement(0, 0, a00);	a.GetElement(1, 0, a10);	a.GetElement(2, 0, a20);	a.GetElement(3, 0, a30);
		a.GetElement(0, 1, a01);	a.GetElement(1, 1, a11);	a.GetElement(2, 1, a21);	a.GetElement(3, 1, a31);
		a.GetElement(0, 2, a02);	a.GetElement(1, 2, a12);	a.GetElement(2, 2, a22);	a.GetElement(3, 2, a32);
		a.GetElement(0, 3, a03);	a.GetElement(1, 3, a13);	a.GetElement(2, 3, a23);	a.GetElement(3, 3, a33);
		iTest.GetElement(0, 0, e00);	iTest.GetElement(1, 0, e10);	iTest.GetElement(2, 0, e20);	iTest.GetElement(3, 0, e30);
		iTest.GetElement(0, 1, e01);	iTest.GetElement(1, 1, e11);	iTest.GetElement(2, 1, e21);	iTest.GetElement(3, 1, e31);
		iTest.GetElement(0, 2, e02);	iTest.GetElement(1, 2, e12);	iTest.GetElement(2, 2, e22);	iTest.GetElement(3, 2, e32);
		iTest.GetElement(0, 3, e03);	iTest.GetElement(1, 3, e13);	iTest.GetElement(2, 3, e23);	iTest.GetElement(3, 3, e33);
		TS_ASSERT_DELTA(a00, e00, delta);
		TS_ASSERT_DELTA(a10, e10, delta);
		TS_ASSERT_DELTA(a20, e20, delta);
		TS_ASSERT_DELTA(a30, e30, delta);
		...
		zero.GetElement(0, 0, a00);	zero.GetElement(1, 0, a10);	zero.GetElement(2, 0, a20);	zero.GetElement(3, 0, a30);
		zero.GetElement(0, 1, a01);	zero.GetElement(1, 1, a11);	zero.GetElement(2, 1, a21);	zero.GetElement(3, 1, a31);
		zero.GetElement(0, 2, a02);	zero.GetElement(1, 2, a12);	zero.GetElement(2, 2, a22);	zero.GetElement(3, 2, a32);
		zero.GetElement(0, 3, a03);	zero.GetElement(1, 3, a13);	zero.GetElement(2, 3, a23);	zero.GetElement(3, 3, a33);
		zTest.GetElement(0, 0, e00);	zTest.GetElement(1, 0, e10);	zTest.GetElement(2, 0, e20);	zTest.GetElement(3, 0, e30);
		zTest.GetElement(0, 1, e01);	zTest.GetElement(1, 1, e11);	zTest.GetElement(2, 1, e21);	zTest.GetElement(3, 1, e31);
		zTest.GetElement(0, 2, e02);	zTest.GetElement(1, 2, e12);	zTest.GetElement(2, 2, e22);	zTest.GetElement(3, 2, e32);
		zTest.GetElement(0, 3, e03);	zTest.GetElement(1, 3, e13);	zTest.GetElement(2, 3, e23);	zTest.GetElement(3, 3, e33);
		TS_ASSERT_DELTA(a00, e00, delta);
		TS_ASSERT_DELTA(a10, e10, delta);
		TS_ASSERT_DELTA(a20, e20, delta);
		TS_ASSERT_DELTA(a30, e30, delta);
	...
	void testAssignment(void)
	{
		...
		VecFloat e02, e12, e22, e32;
		VecFloat e03, e13, e23, e33;
		copya.GetElement(0, 0, e00);	copya.GetElement(1, 0, e10);	copya.GetElement(2, 0, e20);	copya.GetElement(3, 0, e30);
		copya.GetElement(0, 1, e01);	copya.GetElement(1, 1, e11);	copya.GetElement(2, 1, e21);	copya.GetElement(3, 1, e31);
		copya.GetElement(0, 2, e02);	copya.GetElement(1, 2, e12);	copya.GetElement(2, 2, e22);	copya.GetElement(3, 2, e32);
		copya.GetElement(0, 3, e03);	copya.GetElement(1, 3, e13);	copya.GetElement(2, 3, e23);	copya.GetElement(3, 3, e33);
	...
	void testGlobalMatrix4(void)
	{
		...
		GameHalloran::g_zeroMat.GetElement(0, 0, a00);	GameHalloran::g_zeroMat.GetElement(1, 0, a10);	GameHalloran::g_zeroMat.GetElement(2, 0, a20);	GameHalloran::g_zeroMat.GetElement(3, 0, a30);
		GameHalloran::g_zeroMat.GetElement(0, 1, a01);	GameHalloran::g_zeroMat.GetElement(1, 1, a11);	GameHalloran::g_zeroMat.GetElement(2, 1, a21);	GameHalloran::g_zeroMat.GetElement(3, 1, a31);
		GameHalloran::g_zeroMat.GetElement(0, 2, a02);	GameHalloran::g_zeroMat.GetElement(1, 2, a12);	GameHalloran::g_zeroMat.GetElement(2, 2, a22);	GameHalloran::g_zeroMat.GetElement(3, 2, a32);
		GameHalloran::g_zeroMat.GetElement(0, 3, a03);	GameHalloran::g_zeroMat.GetElement(1, 3, a13);	GameHalloran::g_zeroMat.GetElement(2, 3, a23);	GameHalloran::g_zeroMat.GetElement(3, 3, a33);
		...
		GameHalloran::g_identityMat.GetElement(0, 0, a00);	GameHalloran::g_identityMat.GetElement(1, 0, a10);	GameHalloran::g_identityMat.GetElement(2, 0, a20);	GameHalloran::g_identityMat.GetElement(3, 0, a30);
		GameHalloran::g_identityMat.GetElement(0, 1, a01);	GameHalloran::g_identityMat.GetElement(1, 1, a11);	GameHalloran::g_identityMat.GetElement(2, 1, a21);	GameHalloran::g_identityMat.GetElement(3, 1, a31);
		GameHalloran::g_identityMat.GetElement(0, 2, a02);	GameHalloran::g_identityMat.GetElement(1, 2, a12);	GameHalloran::g_identityMat.GetElement(2, 2, a22);	GameHalloran::g_identityMat.GetElement(3, 2, a32);
		GameHalloran::g_identityMat.GetElement(0, 3, a03);	GameHalloran::g_identityMat.GetElement(1, 3, a13);	GameHalloran::g_identityMat.GetElement(2, 3, a23);	GameHalloran::g_identityMat.GetElement(3, 3, a33);
	...
	void testBuildArbitruaryRotation(void)
	{
		...
		// 1) Rotation about the X axis.
		{
			...
			out.GetElement(0, 0, a00);	out.GetElement(1, 0, a10);	out.GetElement(2, 0, a20);	out.GetElement(3, 0, a30);
			out.GetElement(0, 1, a01);	out.GetElement(1, 1, a11);	out.GetElement(2, 1, a21);	out.GetElement(3, 1, a31);
			out.GetElement(0, 2, a02);	out.GetElement(1, 2, a12);	out.GetElement(2, 2, a22);	out.GetElement(3, 2, a32);
			out.GetElement(0, 3, a03);	out.GetElement(1, 3, a13);	out.GetElement(2, 3, a23);	out.GetElement(3, 3, a33);
			TS_ASSERT_DELTA(a00, 1.0f, delta);
			TS_ASSERT_DELTA(a10, 0.0f, delta);
			TS_ASSERT_DELTA(a20, 0.0f, delta);
			TS_ASSERT_DELTA(a30, 0.0f, delta);
