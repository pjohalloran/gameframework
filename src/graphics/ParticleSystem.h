...
namespace GameHalloran {
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline GameColor GetColor() const {
            return (m_color);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetColor(const GameColor &col) {
            m_color = col;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetAcceleration(const Vector3 &accel) {
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetLifetime(const F32 lifetime) {
            m_lifetime = lifetime;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetAge(const F32 age) {
            m_age = age;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetRotating(const bool rotate) {
            m_rotate = rotate;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetRotationAngle(const F32 rotateAngle) {
            m_rotateAngle = rotateAngle;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetRotationAxis(const Vector3 &rotationAxis) {
            m_rotationAxis = rotationAxis;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetSize(const F32 size) {
            m_size = size;
        };
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline Point3 GetEmitOrigin() const {
            return (m_origin);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetEmitOrigin(const Point3 &ptOrigin) {
            m_origin = ptOrigin;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline BoundingCube GetBoundingCube() const {
            return (m_boundBox);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetBoundingCube(const BoundingCube &bb) {
            m_boundBox = bb;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetEmitRate(const F32 emitRate) {
            m_emitRate = emitRate;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline U32 GetMaxParticles() const {
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetMaxParticles(const U32 maxParticles) {
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline Vector3 GetWindDirection() const {
            return (m_windDir);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetWindDirection(const Vector3 &windDir) {
            m_windDir = windDir;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetGravity(const F32 gravity) {
            m_gravity = gravity;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline ImageResource GetTextureResource() const {
