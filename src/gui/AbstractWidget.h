...
namespace GameHalloran {
    ...
    protected:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        void SetQuadDim(const AtlasImage &dim) {
            m_currQuadDim = dim;
            SetupQuad();
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetCurrentTexture(const TexHandle h) {
            m_currentTextureHandle = h;
        };
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        virtual ScreenElementId VGetId() const {
            return (m_id);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        virtual void VSetId(const ScreenElementId id) {
            m_id = id;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        virtual I32 VGetZOrder() const {
            return (static_cast<I32>(m_position.GetZ()));
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        virtual void VSetZOrder(const I32 zOrder) {
            m_position.SetZ(static_cast<F32>(zOrder));
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        virtual Point3 VGetPosition() const {
            return (m_position);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetMvpStackManagerPtr(boost::shared_ptr<ModelViewProjStackManager> mvpStackManPtr) {
        ...
        inline bool IsTextured() const {
            return (m_applyTexture);
        };

        inline bool IsAtlased() const {
            return (!m_atlasName.empty());
        };
