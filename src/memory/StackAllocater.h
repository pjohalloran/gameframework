...
namespace GameHalloran
{
	...
	public:
		...
		//
		// ////////////////////////////////////////////////////////////
		inline bool IsValid() const { return (m_data != NULL); };

		// ////////////////////////////////////////////////////////////
		// Get the size of the stack in bytes.
		//
		// ////////////////////////////////////////////////////////////
		inline U64 GetSize() const { if(!IsValid()) { return (0); } return (m_size); }
		...
		//
		// ////////////////////////////////////////////////////////////
		inline Marker GetMarker() const { return (m_topMarker); };
		...
		//
		// ////////////////////////////////////////////////////////////
		inline Marker GetEndMarker() const { return (m_endMarker); };
		...
		//
		// ////////////////////////////////////////////////////////////
		inline void Clear() { FreeToMarker(0); FreeToMarker(m_size); };
		...
		//
		// ////////////////////////////////////////////////////////////
		inline U32 GetNumberBlocksAllocated() const { return (m_numBlocks); };
