...
namespace GameHalloran
{
	...
	public:
		...
		//// /////////////////////////////////////////////////////////////////
		//// Root node cannot be rendered so this is disabled.
		////
		//// /////////////////////////////////////////////////////////////////
		//virtual bool VPreRender(SceneGraphManager *scenePtr) { return (true); };

		//// /////////////////////////////////////////////////////////////////
		//// Root node cannot be rendered so this is disabled.
		////
		//// /////////////////////////////////////////////////////////////////
		//virtual bool VRender(SceneGraphManager *scenePtr) { return (true); };

		//// /////////////////////////////////////////////////////////////////
		//// Root node cannot be rendered so this is disabled.
		////
		//// /////////////////////////////////////////////////////////////////
		//virtual bool VPostRender(SceneGraphManager *scenePtr) { return (true); };
	};
