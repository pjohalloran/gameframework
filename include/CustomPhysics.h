...
#ifndef __GF_CUSTOM_PHYSICS_H
#define __GF_CUSTOM_PHYSICS_H
...
namespace GameHalloran
{
	...
	// @author PJ O Halloran
	//
	// My own physics/collision detection system.
	//
	// /////////////////////////////////////////////////////////////////
	class CustomPhysics : public IGamePhysics
	{
	...
	public:
		...
		//
		// /////////////////////////////////////////////////////////////////
		virtual void VRemoveTrigger(const int triggerId) { };
		...
		//
		// /////////////////////////////////////////////////////////////////
		virtual F32 VGetOrientationY(const ActorId actorId) { return (0.0f); };
