...
namespace GameHalloran
{
	...
	public:
		...
		//
		// /////////////////////////////////////////////////////////////////
		inline void GetPosition(Point3 &position) const { position = m_position; };
		...
		//
		// /////////////////////////////////////////////////////////////////
		inline bool HasNormal() const { return (m_normal.is_initialized()); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		inline bool HasAnyTextureCoordinates() const { return ((m_texCoordsVec.is_initialized()) && (!m_texCoordsVec->empty())); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		inline bool HasColor() const { return (m_color.is_initialized()); };
