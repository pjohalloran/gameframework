...
namespace GameHalloran {
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        void SetDrawMode(const I32 debugMode) {
            m_ddm = debugMode;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        void TurnOnDrawMode(const enum DrawMode mode) {
            m_ddm |= mode;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        void TurnOffDrawMode(const enum DrawMode mode) {
            m_ddm = m_ddm & (~mode);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        bool IsDrawModeOn(const enum DrawMode mode) const {
            return ((m_ddm & mode) > 0);
        };
