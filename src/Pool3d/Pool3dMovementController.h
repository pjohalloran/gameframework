...
namespace GameHalloran
{
	...
	private:
		...
		//
		// /////////////////////////////////////////////////////////////////
		inline F32 GetRelativeMouseWheelPos() const { return (m_lastMouseWheel == 0 || !m_currMouseWheel.is_initialized() ? 0.0f : F32(*m_currMouseWheel - m_lastMouseWheel)); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		inline void BroadcastViewModeChangeRequestEvent(const enum ViewMode mode) const{ /*safeQueEvent(IEventDataPtr(GCC_NEW EvtData_Camera_Aim_Mode_Request(mode)));*/ safeTriggerEvent(EvtData_Camera_Aim_Mode_Request(mode)); };
	...
	public:
		...
		//
		// /////////////////////////////////////////////////////////////////
		ViewMode GetViewMode() const { return (m_currMode); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		void SetViewMode(const enum ViewMode mode) { m_currMode = mode; OnViewChangeEvent(); };

		// /////////////////////////////////////////////////////////////////
		// Get the cue scene node pointer.
		//
		// /////////////////////////////////////////////////////////////////
		boost::shared_ptr<SceneNode> GetCueSceneNode() const { return (m_cueNode); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		F32 GetRotationAngle() const { return (m_rotAngle); };

		// /////////////////////////////////////////////////////////////////
		// Set the maximum angle of table rotation per second.
		//
		// /////////////////////////////////////////////////////////////////
		void SetRotationAngle(const F32 rotAngle) { if(rotAngle >= 0.0f && rotAngle <= 360.0f) m_rotAngle = rotAngle; };

		// /////////////////////////////////////////////////////////////////
		// Get the maximum distance of camera movement per second (in meters).
		//
		// /////////////////////////////////////////////////////////////////
		F32 GetMovementDistance() const { return (m_moveDistance); };

		// /////////////////////////////////////////////////////////////////
		// Set the maximum distance of camera movement per second (in meters).
		//
		// /////////////////////////////////////////////////////////////////
		void SetMovementDistance(const F32 md) { m_moveDistance = md; };
		...
		//
		// /////////////////////////////////////////////////////////////////
		F32 GetTvTimeout() const { return (m_tableViewTimeout); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		void SetTvTimeout(const F32 timeout) { if(timeout > 0.0f) m_tableViewTimeout = timeout; };

		// /////////////////////////////////////////////////////////////////
		// Get the focus position of the camera while in eTable mode.
		//
		// /////////////////////////////////////////////////////////////////
		Point3 GetTvFocusPosition() const { return (m_focusPos); };

		// /////////////////////////////////////////////////////////////////
		// Set the focus position of the camera while in eTable mode.
		//
		// /////////////////////////////////////////////////////////////////
		void SetTvFocusPosition(const Point3 &position) { m_focusPos = position; };

		// /////////////////////////////////////////////////////////////////
		// Get the current position of the cue ball.
		//
		// /////////////////////////////////////////////////////////////////
		Point3 GetSaCueBallPosition() const { return (m_cueBallPos); };

		// /////////////////////////////////////////////////////////////////
		// Set the current position of the cue ball.
		//
		// /////////////////////////////////////////////////////////////////
		void SetSaCueBallPosition(const Point3 &position) { m_cueBallPos = position; };

		// /////////////////////////////////////////////////////////////////
		// Get the current position of the nearest player ball.
		//
		// /////////////////////////////////////////////////////////////////
		boost::optional<Point3> GetSaNearestPlayerBallPosition() const { return (m_nearPlayerBallPos); };

		// /////////////////////////////////////////////////////////////////
		// Set the current position of the nearest player ball.
		//
		// /////////////////////////////////////////////////////////////////
		void SetSaNearestPlayerBallPosition(const boost::optional<Point3> &position) { m_nearPlayerBallPos = position; };

		// /////////////////////////////////////////////////////////////////
		// Reset the nearest player ball position to hold no value.
		//
		// /////////////////////////////////////////////////////////////////
		void ResetSaNearestPlayerBallPosition() { m_nearPlayerBallPos.reset(); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		F32 GetSaTrailDistance() const { return (m_trailDistance); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		void SetSaTrailDistance(const F32 trailDistance) { if(trailDistance > 0.0f) m_trailDistance = trailDistance; };

		// /////////////////////////////////////////////////////////////////
		// Get the ball radius.
		//
		// /////////////////////////////////////////////////////////////////
		F32 GetSaBallRadius() const { return (m_ballRadius); };

		// /////////////////////////////////////////////////////////////////
		// Set the ball radius.
		//
		// /////////////////////////////////////////////////////////////////
		void SetSaBallRadius(const F32 br) { m_ballRadius = br; };

		// /////////////////////////////////////////////////////////////////
		// Get the current player index.
		//
		// /////////////////////////////////////////////////////////////////
		I32 GetSaCurrPlayerId() const { return (m_currPlayerId); };

		// /////////////////////////////////////////////////////////////////
		// Set the current player index.
		//
		// /////////////////////////////////////////////////////////////////
		void SetSaCurrPlayerId(const I32 pid) { m_currPlayerId = pid; };

		// /////////////////////////////////////////////////////////////////
		// Check if the input is currently locked.
		//
		// /////////////////////////////////////////////////////////////////
		bool IsInputLocked() const { return (m_lockInput); };

		// /////////////////////////////////////////////////////////////////
		// Lock or unlock user input.
		//
		// /////////////////////////////////////////////////////////////////
		void SetInputLock(const bool flag) { m_lockInput = flag; };
