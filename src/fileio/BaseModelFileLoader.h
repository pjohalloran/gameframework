...
namespace GameHalloran {
    ...
    protected:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        void SetFileLoaded(const bool loadStatus) {
            m_loaded = loadStatus;
        };
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        virtual U64 VGetNumberObjects() const {
            return (U64(m_objectMap.size()));
        };
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        LoadingOperation GetStage() const {
            return (LoadingOperation(m_currOperation));
        };
        ...
        bool IsComplete() const {
            return (LoadingOperation(m_currOperation) == eNumberOperations);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        U32 GetModelsLoadedCount() const {
            return (m_modelIndex + 1);
        };
