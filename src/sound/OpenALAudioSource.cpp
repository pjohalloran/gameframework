...
namespace GameHalloran {
    ...
    std::string OpenALAudioSource::GetALEnumString(const ALenum param) const
    {
        ...
        switch(param) {
            case AL_PITCH:
                paramStr.assign("AL_PITCH");
                break;
            case AL_GAIN:
                paramStr.assign("AL_GAIN");
                break;
            case AL_MAX_DISTANCE:
                paramStr.assign("AL_MAX_DISTANCE");
                break;
            case AL_ROLLOFF_FACTOR:
                paramStr.assign("AL_ROLLOFF_FACTOR");
                break;
            case AL_REFERENCE_DISTANCE:
                paramStr.assign("AL_REFERENCE_DISTANCE");
                break;
            case AL_MIN_GAIN:
                paramStr.assign("AL_MIN_GAIN");
                break;
            case AL_MAX_GAIN:
                paramStr.assign("AL_MAX_GAIN");
                break;
            case AL_CONE_OUTER_GAIN:
                paramStr.assign("AL_CONE_OUTER_GAIN");
                break;
            case AL_CONE_INNER_ANGLE:
                paramStr.assign("AL_CONE_INNER_ANGLE");
                break;
            case AL_CONE_OUTER_ANGLE:
                paramStr.assign("AL_CONE_OUTER_ANGLE");
                break;
            case AL_POSITION:
                paramStr.assign("AL_POSITION");
                break;
            case AL_VELOCITY:
                paramStr.assign("AL_VELOCITY");
                break;
            case AL_DIRECTION:
                paramStr.assign("AL_DIRECTION");
                break;
            case AL_SOURCE_RELATIVE:
                paramStr.assign("AL_SOURCE_RELATIVE");
                break;
            case AL_SOURCE_TYPE:
                paramStr.assign("AL_SOURCE_TYPE");
                break;
            case AL_LOOPING:
                paramStr.assign("AL_LOOPING");
                break;
            case AL_BUFFER:
                paramStr.assign("AL_BUFFER");
                break;
            case AL_SOURCE_STATE:
                paramStr.assign("AL_SOURCE_STATE");
                break;
            case AL_BUFFERS_QUEUED:
                paramStr.assign("AL_BUFFERS_QUEUED");
                break;
            case AL_BUFFERS_PROCESSED:
                paramStr.assign("AL_BUFFERS_PROCESSED");
                break;
            case AL_SEC_OFFSET:
                paramStr.assign("AL_SEC_OFFSET");
                break;
            case AL_SAMPLE_OFFSET:
                paramStr.assign("AL_SAMPLE_OFFSET");
                break;
            case AL_BYTE_OFFSET:
                paramStr.assign("AL_BYTE_OFFSET");
                break;
            default:
                paramStr.assign("- Unknown AL enum -");
                break;
        }
        return (paramStr);
    }
