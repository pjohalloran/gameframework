...
namespace GameHalloran {
    ...
    protected:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetBatch(boost::shared_ptr<IGLBatchBase> newBatch) {
            m_batchPtr = newBatch;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline bool IsBatchValid() const {
            return (m_batchPtr.get() != NULL);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetTextureHandle(boost::optional<TexHandle> texHandle) {
