...
//	LUAPLUS_CLASS_API inline void Push(lua_State* L, LuaPlus::LuaObject& value);
    
	inline bool	Match(TypeWrapper<LuaPlus::LuaObject>, lua_State* L, int idx)
		{  (void)L, (void)idx;  return true;  }
//	LUAPLUS_CLASS_API inline LuaPlus::LuaObject Get(TypeWrapper<LuaPlus::LuaObject>, lua_State* L, int idx);
