...
namespace GameHalloran {
    ...
    :
        ...
        //
        // /////////////////////////////////////////////////////////////////
        virtual ~EvtData_Complex_Mesh_Loaded() {
            try {
                Delete(m_params);
            } catch(...) {}
        };
    ...
    :
        ...
        //
        // /////////////////////////////////////////////////////////////////
        Vector3 GetSpinDirection() const {
            return (m_spinDir);
        };
    ...
    :
        ...
        //
        // /////////////////////////////////////////////////////////////////
        boost::optional<Point3> GetFinalCueBallPosition() const {
        ...
        //
        // /////////////////////////////////////////////////////////////////
        boost::optional<Point3> GetNearestBallPosition() const {
            return (m_nearestBallPos);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        bool IsCueBallAlive() const {
            return (m_cueBallPosition.is_initialized());
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        bool IsGameEndPenalty() const {
            return (m_gameEndPenalty);
        };
    ...
    :
        ...
        //
        // /////////////////////////////////////////////////////////////////
        I32 GetWinnerPlayerId() const {
            return (m_winnerPlayerId);
        };
    ...
    :
        ...
        //
        // /////////////////////////////////////////////////////////////////
        Point3 GetStartingPosition() const {
            return (m_startPos);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        Point3 GetEndingPosition() const {
            return (m_endPos);
        };
    ...
    :
        ...
        //
        // /////////////////////////////////////////////////////////////////
        Point3 GetCueBallPosition() const {
            return (m_cueBallPos);
        };
