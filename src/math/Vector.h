...
namespace GameHalloran {
    ...
    public:
        ...
        explicit inline Vector3() {
            memset(m_vec, 0, sizeof(F32) * NUMBER_COMPONENTS);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        explicit inline Vector3(const F32 vecArr[NUMBER_COMPONENTS]) {
            memcpy(m_vec, vecArr, sizeof(F32) * NUMBER_COMPONENTS);
        };
        ...
        inline Vector3(const Vector3 &copyVec) {
            memcpy(m_vec, copyVec.m_vec, sizeof(F32) * NUMBER_COMPONENTS);
        };
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        explicit inline Vector4(const F32 vecArr[NUMBER_COMPONENTS]) {
            memcpy(m_vec, vecArr, sizeof(F32) * NUMBER_COMPONENTS);
        };
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        explicit inline Point3(const F32 ptArr[NUMBER_COMPONENTS]) {
            memcpy(m_vec, ptArr, sizeof(F32) * NUMBER_COMPONENTS);
        };
        ...
        inline Point3(const Point3 &copyPt) {
            memcpy(m_vec, copyPt.m_vec, sizeof(F32) * NUMBER_COMPONENTS);
        };
