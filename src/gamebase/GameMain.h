...
namespace GameHalloran
{
	...
	class GameMain
	{
		...
		public:
			...
			//
			// /////////////////////////////////////////////////////////////////
			boost::shared_ptr<WindowManager> GetWindowManager() { return (m_windowManagerPtr); };

			// /////////////////////////////////////////////////////////////////
			// Get a pointer to the global resource cache.
			//
			// /////////////////////////////////////////////////////////////////
			boost::shared_ptr<ResCache> GetResourceCache() { return (m_resourceCachePtr); };

			// /////////////////////////////////////////////////////////////////
			// Get a pointer to the global LUA scripting state manager.
			//
			// /////////////////////////////////////////////////////////////////
			boost::shared_ptr<LuaStateManager> GetLuaStateManager() { return (m_luaStateManagerPtr); };

			// /////////////////////////////////////////////////////////////////
			// Get a pointer to the global event manager.
			//
			// /////////////////////////////////////////////////////////////////
			boost::shared_ptr<EventManager> GetEventManager() { return (m_eventManagerPtr); };

			// /////////////////////////////////////////////////////////////////
			// Get the pointer to the logic layer.
			//
			// /////////////////////////////////////////////////////////////////
			boost::shared_ptr<BaseGameLogic> GetLogicPtr() { return (m_logicPtr); };

			// /////////////////////////////////////////////////////////////////
			// Get the game options.
			//
			// /////////////////////////////////////////////////////////////////
			boost::shared_ptr<GameOptions> GetGameOptions() { return (m_optionsPtr); };

			// /////////////////////////////////////////////////////////////////
			// Get the logging object.
			//
			// /////////////////////////////////////////////////////////////////
			boost::shared_ptr<GameLog> GetLoggerPtr() { return (m_loggerPtr); };
			...
			//
			// /////////////////////////////////////////////////////////////////
			boost::filesystem::path GetGameRootDir() const { return (m_gameRootDir); };

			// /////////////////////////////////////////////////////////////////
			// Get the global data directory.
			//
			// /////////////////////////////////////////////////////////////////
			boost::filesystem::path GetDatatDir() const { return (m_dataDir); };

			// /////////////////////////////////////////////////////////////////
			// Get the application specific directory.
			//
			// /////////////////////////////////////////////////////////////////
			boost::filesystem::path GetAppDataDir() const { return (m_appDataDir); };

			// /////////////////////////////////////////////////////////////////
			// Get the global LUA scripts directory.
			//
			// /////////////////////////////////////////////////////////////////
			boost::filesystem::path GetLuaDataDir() const { return (m_luaCommonDir); };

			// /////////////////////////////////////////////////////////////////
			// Get the save game directory.
			//
			// /////////////////////////////////////////////////////////////////
			boost::filesystem::path GetSaveGameDir() const { return (m_saveGameDir); };
