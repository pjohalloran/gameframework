...
namespace GameHalloran {
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        boost::shared_ptr<GLSLShader> GetAdsShader() {
            return (m_globalShaderPtr);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetCamera(boost::shared_ptr<CameraSceneNode> camera) {
            if(camera) {
                m_camera = camera;
            }
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline const boost::shared_ptr<CameraSceneNode> GetCamera() const {
            return (m_camera);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline boost::shared_ptr<ModelViewProjStackManager> GetStackManager() {
            return (m_stackManagerPtr);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void AddAlphaSceneNode(boost::shared_ptr<AlphaSceneNode> asn) {
            if(asn) {
                m_alphaNodeList.push_back(asn);
            }
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline bool Pick(const RayCast &ray) {
            return (m_root->VPick(ray));
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void EnableFogEffect(const int type) {
            if(type >= 0 && type < FogEffectAttributes::eTYPE_COUNT) {
                m_fogAtt.m_type = type;
            }
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline bool IsFogOn() const {
            return (m_fogAtt.m_type != FogEffectAttributes::eOff);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetFogEffectAttributes(const struct FogEffectAttributes &att) {
            m_fogAtt = att;
        }
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline struct FogEffectAttributes GetFogEffectAttributes() {
            return (m_fogAtt);
        };
