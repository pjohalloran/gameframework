...
namespace GameHalloran
{
	...
	public:
		...
		//
		// /////////////////////////////////////////////////////////////////
		const char * const GetTextureName() const { return (m_textureName); };

		// /////////////////////////////////////////////////////////////////
		// Set the texture name.
		//
		// /////////////////////////////////////////////////////////////////
		void SetTextureName(const std::string &textureName) { SetStringMember(m_textureName, textureName); };

		// /////////////////////////////////////////////////////////////////
		// Get the shader name.
		//
		// /////////////////////////////////////////////////////////////////
		const char * const GetShaderName() const { return (m_shaderName); };

		// /////////////////////////////////////////////////////////////////
		// Set the shader name.
		//
		// /////////////////////////////////////////////////////////////////
		void SetShaderName(const std::string &shaderName) { SetStringMember(m_shaderName, shaderName); };

		// /////////////////////////////////////////////////////////////////
		// Get the mesh name.
		//
		// /////////////////////////////////////////////////////////////////
		const char * const GetMeshName() const { return (m_meshName); };

		// /////////////////////////////////////////////////////////////////
		// Set the mesh name.
		//
		// /////////////////////////////////////////////////////////////////
		void SetMeshName(const std::string &meshName) { SetStringMember(m_meshName, meshName); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		PhysicsActorInfo GetPhysicsInfo() const { return (m_physicsInfo); };

		// /////////////////////////////////////////////////////////////////
		// Get the actors physics information.
		//
		// /////////////////////////////////////////////////////////////////
		void SetPhysicsInfo(const PhysicsActorInfo &physicsInfo) { m_physicsInfo = physicsInfo; };
	...
	public:
		...
		//
		// /////////////////////////////////////////////////////////////////
		void SetRadius(const F32 radius) { m_radius = radius; };

		// /////////////////////////////////////////////////////////////////
		// Get the number of stacks.
		//
		// /////////////////////////////////////////////////////////////////
		I32 GetStacks() const { return (m_stacks); };

		// /////////////////////////////////////////////////////////////////
		// Set the number of stacks.
		//
		// /////////////////////////////////////////////////////////////////
		void SetStacks(const I32 stacks) { m_stacks = stacks; };

		// /////////////////////////////////////////////////////////////////
		// Get the number of slices.
		//
		// /////////////////////////////////////////////////////////////////
		I32 GetSlices() const { return (m_slices); };

		// /////////////////////////////////////////////////////////////////
		// Set the number of slices.
		//
		// /////////////////////////////////////////////////////////////////
		void SetSlices(const I32 slices) { m_slices = slices; };

		// /////////////////////////////////////////////////////////////////
		// Get the ballgroup.
		//
		// /////////////////////////////////////////////////////////////////
		BallGroup GetBallGroup() const { return (m_group); };

		// /////////////////////////////////////////////////////////////////
		// Set the ball group.
		//
		// /////////////////////////////////////////////////////////////////
		void SetBallGroup(const BallGroup group) { m_group = group; };
	};
	...
	public:
		...
		//
		// /////////////////////////////////////////////////////////////////
		std::string GetFrontPanelMeshName() const { return (std::string(m_frontPanelMeshName)); };

		// /////////////////////////////////////////////////////////////////
		// Set the front panel RC ID.
		//
		// /////////////////////////////////////////////////////////////////
		void SetFrontPanelMeshName(const std::string &str) { SetStringMember(m_frontPanelMeshName, str); };

		// /////////////////////////////////////////////////////////////////
		// Get the back panel mesh RC ID.
		//
		// /////////////////////////////////////////////////////////////////
		std::string GetSidePanelMeshName() const { return (std::string(m_sidePanelMeshName)); };

		// /////////////////////////////////////////////////////////////////
		// Set the side panel RC ID.
		//
		// /////////////////////////////////////////////////////////////////
		void SetSidePanelMeshName(const std::string &str) { SetStringMember(m_sidePanelMeshName, str); };

		// /////////////////////////////////////////////////////////////////
		// Get the panel RC texture ID.
		//
		// /////////////////////////////////////////////////////////////////
		std::string GetPanelTextureName() const { return (std::string(m_panelTextureName)); };

		// /////////////////////////////////////////////////////////////////
		// Set the panel RC texture ID.
		//
		// /////////////////////////////////////////////////////////////////
		void SetPanelTextureName(const std::string &str) { SetStringMember(m_panelTextureName, str); };

		// /////////////////////////////////////////////////////////////////
		// Get the material used to light the table panels.
		//
		// /////////////////////////////////////////////////////////////////
		Material GetTablePanelMaterial() const { return (m_panelMaterial); };

		// /////////////////////////////////////////////////////////////////
		// Set the material used to light the table panels.
		//
		// /////////////////////////////////////////////////////////////////
		void SetTablePanelMaterial(const Material &material) { m_panelMaterial = material; };

		// /////////////////////////////////////////////////////////////////
		// Get the middle pocket mesh RC ID.
		//
		// /////////////////////////////////////////////////////////////////
		std::string GetMiddlePocketMeshName() const { return (std::string(m_middlePocketMeshName)); };

		// /////////////////////////////////////////////////////////////////
		// Set the middle pocket mesh RC ID.
		//
		// /////////////////////////////////////////////////////////////////
		void SetMiddlePocketMeshName(const std::string &str) { SetStringMember(m_middlePocketMeshName, str); };

		// /////////////////////////////////////////////////////////////////
		// Get the corner pocket mesh RC ID.
		//
		// /////////////////////////////////////////////////////////////////
		std::string GetCornerPocketMeshName() const { return (std::string(m_cornerPocketMeshName)); };

		// /////////////////////////////////////////////////////////////////
		// Set the corner pocket mesh RC ID.
		//
		// /////////////////////////////////////////////////////////////////
		void SetCornerPocketMeshName(const std::string &str) { SetStringMember(m_cornerPocketMeshName, str); };

		// /////////////////////////////////////////////////////////////////
		// Get the material used to light the table pockets.
		//
		// /////////////////////////////////////////////////////////////////
		Material GetTablePocketMaterial() const { return (m_pocketsMaterial); };

		// /////////////////////////////////////////////////////////////////
		// Set the material used to light the table pockets.
		//
		// /////////////////////////////////////////////////////////////////
		void SetTablePocketMaterial(const Material &material) { m_pocketsMaterial = material; };

		// /////////////////////////////////////////////////////////////////
		// Get the name of the texture to apply to the pockets.
		//
		// /////////////////////////////////////////////////////////////////
		std::string GetPocketTextureName() const { return (std::string(m_pocketTextureName)); };

		// /////////////////////////////////////////////////////////////////
		// Set the name of the texture to apply to the pockets.
		//
		// /////////////////////////////////////////////////////////////////
		void SetPocketTextureName(const std::string &str) { SetStringMember(m_pocketTextureName, str); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		void SetWidth(const F32 width) { m_width = width; };
		...
		//
		// /////////////////////////////////////////////////////////////////
		void SetHeight(const F32 height) { m_height = height; };
		...
		//
		// /////////////////////////////////////////////////////////////////
		void SetDepth(const F32 depth) { m_depth = depth; };

		// /////////////////////////////////////////////////////////////////
		// Get the table pocket radius.
		//
		// /////////////////////////////////////////////////////////////////
		F32 GetPocketRadius() const { return (m_pocketRadius); };

		// /////////////////////////////////////////////////////////////////
		// Set the table pocket radius.
		//
		// /////////////////////////////////////////////////////////////////
		void SetPocketRadius(const F32 pocketRadius) { m_pocketRadius = pocketRadius; };
		...
		//
		// /////////////////////////////////////////////////////////////////
		Point3 GetTopLeftPocketTriggerPos() const { return (m_tlpTriggerPos); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		I32 GetTopLeftPocketTriggerId() const { return (m_tlPocketId); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		Point3 GetTopRightPocketTriggerPos() const { return (m_trpTriggerPos); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		I32 GetTopRightPocketTriggerId() const { return (m_trPocketId); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		Point3 GetBottomLeftPocketTriggerPos() const { return (m_blpTriggerPos); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		const I32 GetBottomLeftPocketTriggerId() const { return (m_blPocketId); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		Point3 GetBottomRightPocketTriggerPos() const { return (m_brpTriggerPos); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		I32 GetBottomRightPocketTriggerId() const { return (m_brPocketId); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		Point3 GetMiddleLeftPocketTriggerPos() const { return (m_mlpTriggerPos); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		I32 GetMiddleLeftPocketTriggerId() const { return (m_mlPocketId); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		Point3 GetMiddleRightPocketTriggerPos() const { return (m_mrpTriggerPos); };
		...
		//
		// /////////////////////////////////////////////////////////////////
		I32 GetMiddleRightPocketTriggerId() const { return (m_mrPocketId); };
