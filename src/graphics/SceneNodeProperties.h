...
namespace GameHalloran {
    ...
    :
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline boost::optional<ActorId> GetActorId() const {
            return (m_actorId);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetActorId(boost::optional<ActorId> id) {
            m_actorId = id;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline Matrix4 GetToWorld() const {
            return (m_toWorld);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetToWorld(const Matrix4 &toWorld) {
            m_toWorld = toWorld;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline Matrix4 GetFromWorld() const {
            return (m_fromWorld);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetFromWorld(const Matrix4 &fromWorld) {
            m_fromWorld = fromWorld;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetName(const std::string &nameRef) {
            m_name = nameRef;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline AlphaType GetAlphaType() const {
            return (m_alphaType);
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetAlphaType(const AlphaType alpha) {
            m_alphaType = alpha;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetRenderPass(const RenderPass pass) {
            m_renderPass = pass;
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void SetShaderName(const std::string &shaderName) {
            m_shaderName = shaderName;
        };
