...
namespace GameHalloran {
    ...
    public:
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void GetValue(GLint &val) {
            assert(m_type == eInt);
            val = m_value.m_intArr[0];
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void GetValue(GLint *arr) {
            assert(m_type == eIntArr);
            assert(arr != NULL);
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void GetValue(GLfloat &val) {
            assert(m_type == eFloat);
            val = m_value.m_floatArr[0];
        };
        ...
        //
        // /////////////////////////////////////////////////////////////////
        inline void GetValue(GLfloat *arr) {
            assert(m_type == eFloatArr);
            assert(arr != NULL);
